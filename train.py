...
for dataset, setting in benchmark_settings.items():
    ...
    history_cutoff = 100 # len(sentences) # 2000
    ...
    Log3T.train(batch,epoch_n=5,output=dataset,model=model)
    torch.save(model.state_dict(), f'torch_model_100_5/model_{dataset}_{type}')
